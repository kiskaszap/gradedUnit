...
import ActivitiesHeader from '../assets/activitiesHeader.jpg'
    ...
    <div>
      <header className=' h-[calc(70vh-4.5rem)] relative mb-32'>
        <div
          ...
          style={{ backgroundImage: `url(${ActivitiesHeader})` }}
        >
          <div className='header__sub2 bg-black  h-full w-full opacity-60 absolute top-0 left-0 overflow-hidden'>
            <div
              className='header__sub3 absolute  -bottom-10 left-0 h-full top-60 xl:bg-cover w-full bg-center bg-no-repeat opacity-80 '
        ...
        <div className='header__sub2--content text-white  opacity-100 absolute top-0 left-0 flex h-full w-full  items-center  pl-[5rem] '>
          <div className='w-full items-center justify-center'>
            <h2 className='z-50 text-3xl text-center'>Activities</h2>
            <h1 className='text-[2.6rem] font-extrabold text-center'>
              Browse our activities and join as many as you want
            </h1>
          </div>
        </div>
      </header>
