...
const DropdownNav = () => {
 ...
 {/* max-sm:hidden max-md:hidden lg1077:hidden  md:hidden */}
            ...
            <li className='border-b-2 border-transparent transition-all duration-1000 hover:border-[#0FCE7E]' onClick={toggleNav}>
              <Link to='/'>Home</Link>
            </li>
            <li className='border-b-2 border-transparent transition-all duration-1000 hover:border-[#0FCE7E]' onClick={toggleNav}>
            ...
            <li className='border-b-2 border-transparent transition-all duration-1000 hover:border-[#0FCE7E] md:hidden' onClick={toggleNav}>
